...
public class DrawerService extends Service {
    ...
    public void onCreate() {
        System.out.println("====DrawerService==onCreate 1==");
        mHandler = new MHandler(this);
        workThread = new WorkThread(mHandler);
        workThread.start();
        Log.v("DrawerService", "onCreate");
        System.out.println("====DrawerService==onCreate 2==");
    }

    @Override
    public int onStartCommand(Intent intent, int flags, int startId) {
        Log.v("DrawerService", "onStartCommand");
        System.out.println("====DrawerService==onStartCommand 1==");
        Message msg = Message.obtain();
        msg.what = Global.MSG_ALLTHREAD_READY;
        notifyHandlers(msg);
        System.out.println("====DrawerService==onStartCommand 2==");
